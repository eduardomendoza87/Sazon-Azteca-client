  ...
  return (
    <footer className="bg-grisvolcan text-blancohueso font-cuerpo py-12 px-4">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          <h3 className="font-titulo text-lg text-white mb-4">
            Mapa del Sitio
          </h3>
          <ul className="space-y-2">
            <li>
              <Link to="/" className="text-sm text-fondo hover:text-white">
                Inicio
              </Link>
            </li>
            <li>
              <Link
                to="/filosofia"
                className="text-sm text-fondo hover:text-white"
              >
                Nuestra Filosofía
              </Link>
            </li>
            <li>
              <Link to="/menu" className="text-sm text-fondo hover:text-white">
                El Menú
              </Link>
            </li>
            <li>
      ...
      <div className="container mx-auto border-t border-terracota/30 mt-8 pt-6 text-center">
        <p className="text-sm text-fondo">
          © 2025 Sazón Azteca. Todos los derechos reservados. | Aviso de
          Privacidad
        </p>
      </div>
    </footer>
