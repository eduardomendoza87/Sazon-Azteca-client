    ...
    <>
      ...
      <section className="bg-blancohueso py-16 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex justify-center">
            <img src={history.imagenIngredientes} alt="Ingredientes" className="rounded-lg shadow-xl" />
          </div>
        </div>
      </section>
      ...
      <SectionWall title="Procedencia">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="flex justify-center">
            <img src={history.imagenProcedencia} alt="Procedencia" className="rounded-lg shadow-xl" />
          </div>
          <div className="text-left">
