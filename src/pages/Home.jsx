      ...
      <section className="bg-blancohueso py-16 px-4">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="font-cuerpo text-2xl font-bold text-grisvolcan mb-2">
              Chef
            </p>
            <p className="font-cuerpo text-2xl font-bold text-grisvolcan mb-8">
              Ricardo Perez Muñoz
            </p>
            <p className="font-cuerpo text-lg text-parrafo">
              Considerado como uno de los 24 top chefs de Latinoamérica por la
              revista Gato Pardo (en el 2002) y uno de los siete más importantes
              de México según la  revista Día Siete de México (también en el
              2002) así como uno de los 12 mejores chefs de México de acuerdo
              con la cadena de restaurantes Sanborns.{" "}
            </p>
          </div>
