        ...
        <section className="min-h-screen w-full ">
          ...
          <SectionWall title="Contáctanos">
            <div className="max-w-3xl mx-auto mb-12 gap-4 ">
              {/*Horarios*/}
              <h3 className="text-center text-grisvolcan text-2xl font-extrabold mt-6">
                Horarios
              </h3>
              <p className="text-center text-grisvolcan text-xl font-light">
              ...
              <p className="text-center text-grisvolcan text-xl font-light">
                Calle Falsa 123, Villahermosa, Tabasco, México
              </p>
              ...
              <p className="text-center text-grisvolcan text-xl font-light mb-6">
                Email: contacto@sazonazteca.com
              </p>
          ...
          <SectionWall>
            ...
            >
              <h2 className="text-3xl font-extrabold mb-6 text-center text-grisvolcan">
                Envíanos un mensaje
              </h2>
              <p className="text-center text-grisvolcan text-xl font-medium">
                Para eventos privados, preguntas generales o comentarios, por
